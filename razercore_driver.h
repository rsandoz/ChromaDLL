...
DLL_INTERNAL unsigned int init_razer_core_driver(struct hid_device** hdev);
DLL_INTERNAL struct device_attribute devcore_attr_matrix_effect_custom;
DLL_INTERNAL struct device_attribute devcore_attr_matrix_custom_frame;
#endif
