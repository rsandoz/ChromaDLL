...
DLL_INTERNAL unsigned int init_razer_firefly_driver(struct hid_device** hdev);
DLL_INTERNAL struct device_attribute devfirefly_attr_matrix_effect_custom;
DLL_INTERNAL struct device_attribute devfirefly_attr_matrix_custom_frame;
#endif
#endif
